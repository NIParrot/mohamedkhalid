  ...
  methods: {
    ...
    "aria": {
      ...
      render: function(data, type, row, meta) {
              return `
              <div data-link="/doctor/reports/${ row.id }" style="cursor: pointer; color:#0d6efd; width:100% " class="btn btn-primary" onclick="$nuxt.$router.push(this.getAttribute('data-link'))">
                  ${ data}
            </div>`
            },
          },
