...
<div  class="large" dir="rtl" role="main">
	...
	<div>
      ...
      <div>
				<div class="row">       
					<div class="col-md-6">
						<h3 class="text-center" style="color: #000;font-size:25px;">{{ artical.name }}</h3>
            <h5 class="float-left" style="color:#000;font-size:10px;">{{artical.notes}}</h5>
            <h5 class="float-right" style="color:#000;font-size:10px;">{{artical.update_at}}</h5>
            <br>
            <div class="clearfix"></div>
  <div style="color:#000" class="acf" v-html="renderHtmlCkeditor(artical.description)"></div>
  					</div>
          <div class="col-md-6">
