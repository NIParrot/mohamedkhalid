<template>
  <div class="row">
                <div data-link="/Dashboard/reports_upload/add" class="btn text-right ml-auto" onclick="$nuxt.$router.push(this.getAttribute('data-link'))">
                رفع القرار 
            </div>
  ...
  " class="delete_button" data-toggle="modal" data-target="#deleteElement">
    ...
    `,
          },
          {
            ...
            render: function(data, type, row, meta) {
              return `
              <div data-link="/Dashboard/reports_upload/edit/${data}/"
              style="
                  padding: 0.5rem 1rem;
                  border-radius: 5px;
                  left: 1rem;
